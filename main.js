...
recognition.onresult = function(event) {
 ...
 content = event.results[0][0].transcript;
    ...
    {
      document.getElementById("status").innerHTML = "Se empezó a dibujar un Among us."; 
      draw_apple = "set";
    }
    else
    {
...
function draw() {
  if(draw_apple == "set")
  {
    for(var i = 1 ; i <= to_number; i++)
    {
      ...
      y = Math.floor(Math.random() * 555);
      image(apple, x, y, 50, 50);
    }
    document.getElementById("status").innerHTML = to_number + " Among us dibujadas.";
    speak_data = to_number + " Among us dibujadas.";
    speak();
    draw_apple = "";
  }
}
